...
# Logging period in Iterations. If Iterations % LOG_PERIOD == 0 actual loss
# values are written to train_log.json
__C.TRAIN.LOG_PERIOD = 20
...
# Remove FC6 and FC7 and resize cls_score and bbox_pred weights and biases
# to match necessary output size
# Only usable if MODEL.RPN_ONLY is True
__C.MODEL.RPN_RA_AND_BP = False
...
# Multi-task loss weight for classification
__C.FAST_RCNN.WEIGHT_LOSS_CLASSIFICATION = 1.0

# Multi-task loss weight for regression
__C.FAST_RCNN.WEIGHT_LOSS_REGRESSION = 1.0
