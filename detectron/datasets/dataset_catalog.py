...
_DATASETS = {
    ...
    # This is manipulated for our dataset
    ## VIS subset
    ### 1 class
    'smd_VIS_train_2': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_train.json'
    },
    ...
    'smd_VIS_train_2_seg': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_train_seg.json'
    },
    
    'smd_VIS_test_2': {
        _IM_DIR:
            '/dataIn/Test/VIS/frames',
        _ANN_FN:
            '/dataIn/Test/VIS/SMD_VIS_skip_2.json'
    },    
    ...
    'smd_VIS_val_2': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_val.json'
    },
    ...
    'smd_VIS_train_2_10c': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_10c_train.json'
    },
     
    'smd_VIS_train_2_10c_seg': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_10c_train_seg.json'
    },
    ...
    'smd_VIS_test_2_10c': {
        _IM_DIR:
            '/dataIn/Test/VIS/frames',
        _ANN_FN:
            '/dataIn/Test/VIS/SMD_VIS_skip_2_10c.json'
    },
    ...
    'smd_VIS_val_2_10c': {
        _IM_DIR:
            '/dataIn/Train/VIS/frames',
        _ANN_FN:
            '/dataIn/Train/VIS/SMD_VIS_skip_2_10c_val.json'
    },
    ...
    'smd_NIR_train_2': {
        _IM_DIR:
            '/dataIn/Train/NIR/frames',
        _ANN_FN:
            '/dataIn/Train/NIR/SMD_NIR_skip_2_train.json'
    },
    ...
    'smd_NIR_train_2_seg': {
        _IM_DIR:
            '/dataIn/Train/NIR/frames',
        _ANN_FN:
            '/dataIn/Train/NIR/SMD_NIR_skip_2_train_seg.json'
    },
    
    'smd_NIR_test_2': {
        _IM_DIR:
            '/dataIn/Test/NIR/frames',
        _ANN_FN:
            '/dataIn/Test/NIR/SMD_NIR_skip_2.json'
    },
    ...
    'smd_NIR_train_2_10c': {
        _IM_DIR:
            '/dataIn/Train/NIR/frames',
        _ANN_FN:
            '/dataIn/Train/NIR/SMD_NIR_skip_2_10c_train.json'
    },
     
    'smd_NIR_train_2_10c_seg': {
        _IM_DIR:
            '/dataIn/Train/NIR/frames',
        _ANN_FN:
            '/dataIn/Train/NIR/SMD_NIR_skip_2_10c_train_seg.json'
    },
    ...
    'smd_NIR_test_2_10c': {
        _IM_DIR:
            '/dataIn/Test/NIR/frames',
        _ANN_FN:
            '/dataIn/Test/NIR/SMD_NIR_skip_2_10c.json'
    }
}
